...
exports.userRouter.get("/user-details", varifyToken_1.verifyToken, userController_1.userDetails);
exports.userRouter.get("/my-codes", varifyToken_1.verifyToken, compilerController_1.getMyCodes);
